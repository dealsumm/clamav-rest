...
# start in background
java -jar /var/clamav-rest/clamav-rest-1.0.2.jar --clamd.host=$host --clamd.port=$port --clamd.maxfilesize=$maxfilesize --clamd.maxrequestsize=$maxrequestsize --clamd.timeout=$timeout
